...
class InstagramFollow(unittest.TestCase):
    ...
    def test(self):
        ...
        follow_button.click()
        time.sleep(3)
        following_button = driver.find_element_by_xpath("//button[text()='Following']")
        self.assertEqual("Following", following_button.get_attribute("textContent"))
